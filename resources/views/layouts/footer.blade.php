...
<!-- Main My Work -->
<script src="{{url($js_path)}}/custmer/order.js"></script>
...
<script src="{{url($plugin_path)}}/morris/morris.min.js"></script>
<!-- Sparkline -->
...
<script src="{{url($plugin_path)}}/ckeditor/ckeditor.js"></script>
